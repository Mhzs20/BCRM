                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="gift_sms_count" id="gift_sms_count" value="{{ old('gift_sms_count', $package->gift_sms_count) }}" min="0" step="100"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-150"
                                   placeholder="1000"
                                   required>
                        ...
                        <div>
                            ...
                            <input type="number" name="duration_days" id="duration_days" value="{{ old('duration_days', $package->duration_days) }}" min="1" max="3650"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-150"
                                   placeholder="365"
                                   required>
                            @error('duration_days')
                    ...
                    <div>
                        ...
                        <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 max-h-96 overflow-y-auto space-y-3">
                            @php
                                $selectedOptions = old('options', $package->options->pluck('id')->toArray());
                            @endphp
