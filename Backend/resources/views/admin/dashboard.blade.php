    ...
    <div class="py-6 sm:py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                ...
                <div class="bg-white overflow-hidden shadow-md sm:rounded-lg p-4 sm:p-6 col-span-1 sm:col-span-2 lg:col-span-2">
                    <div class="flex items-center mb-4">
                        <div class="flex-shrink-0 bg-blue-500 rounded-md p-3">
                            <i class="ri-group-line text-xl sm:text-2xl text-white"></i>
                        </div>
                        <div class="mr-4">
                            <h3 class="text-base sm:text-lg font-semibold text-gray-700">آمار کاربران (کل: {{ $totalUsers }})</h3>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between items-center text-sm sm:text-base"><span class="flex items-center"><span class="w-3 h-3 rounded-full bg-green-500 mr-2"></span>فعال:</span><span class="font-semibold">{{ $activeUsers }}</span></div>
                            <div class="flex justify-between items-center text-sm sm:text-base"><span class="flex items-center"><span class="w-3 h-3 rounded-full bg-red-500 mr-2"></span>غیرفعال:</span><span class="font-semibold">{{ $inactiveUsers }}</span></div>
                            <div class="flex justify-between items-center text-sm sm:text-base"><span class="flex items-center"><span class="w-3 h-3 rounded-full bg-yellow-500 mr-2"></span>در انتظار:</span><span class="font-semibold">{{ $pendingUsers }}</span></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-md sm:rounded-lg p-4 sm:p-6 col-span-1 sm:col-span-2 lg:col-span-2">
                    <div class="flex items-center mb-4">
                        <div class="flex-shrink-0 bg-green-500 rounded-md p-3">
                            <i class="ri-calendar-check-line text-xl sm:text-2xl text-white"></i>
                        </div>
                        <div class="mr-4">
                            <h3 class="text-base sm:text-lg font-semibold text-gray-700">رزروهای امروز (کل: {{ $totalAppointmentsToday }})</h3>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                        <div class="h-48 sm:h-auto">
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between items-center text-sm sm:text-base"><span class="flex items-center"><span class="w-3 h-3 rounded-full bg-green-500 mr-2"></span>تکمیل شده:</span><span class="font-semibold">{{ $completedAppointmentsToday }}</span></div>
                            <div class="flex justify-between items-center text-sm sm:text-base"><span class="flex items-center"><span class="w-3 h-3 rounded-full bg-red-500 mr-2"></span>لغو شده:</span><span class="font-semibold">{{ $cancelledAppointmentsToday }}</span></div>
                            <div class="flex justify-between items-center text-sm sm:text-base"><span class="flex items-center"><span class="w-3 h-3 rounded-full bg-yellow-500 mr-2"></span>در انتظار:</span><span class="font-semibold">{{ $pendingAppointmentsToday }}</span></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-md sm:rounded-lg p-4 sm:p-6 flex flex-col">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 bg-purple-500 rounded-md p-3">
                            <i class="ri-store-2-line text-xl sm:text-2xl text-white"></i>
                        </div>
                        <div class="mr-4">
                            <h3 class="text-base sm:text-lg font-semibold text-gray-700">سالن‌ها و کلینیک‌ها</h3>
                        </div>
                    </div>
                    <div class="mt-4 flex-grow flex items-center justify-center">
                        <div class="text-center">
                            <p class="text-gray-600 text-sm sm:text-base">تعداد کل</p>
                            <p class="font-bold text-2xl sm:text-4xl">{{ $totalSalons }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-md sm:rounded-lg p-4 sm:p-6 flex flex-col">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 bg-yellow-500 rounded-md p-3">
                            <i class="ri-message-3-line text-xl sm:text-2xl text-white"></i>
                        </div>
                        <div class="mr-4">
                            <h3 class="text-base sm:text-lg font-semibold text-gray-700">آمار پیامک</h3>
                        </div>
                    </div>
                ...
                <!-- Income Stats -->
                <div class="bg-white overflow-hidden shadow-md sm:rounded-lg p-4 sm:p-6 flex flex-col col-span-1 sm:col-span-2">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 bg-red-500 rounded-md p-3">
                            <i class="ri-money-dollar-circle-line text-xl sm:text-2xl text-white"></i>
                        </div>
                        <div class="mr-4">
                            <h3 class="text-base sm:text-lg font-semibold text-gray-700">درآمد (تومان)</h3>
                        </div>
                    </div>
                    <div class="mt-4 space-y-2">
                ...
                <div class="bg-white overflow-hidden shadow-md sm:rounded-lg p-4 sm:p-6 flex flex-col col-span-1 sm:col-span-2">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 bg-teal-500 rounded-md p-3">
                            <i class="ri-line-chart-line text-xl sm:text-2xl text-white"></i>
                        </div>
                        <div class="mr-4">
                            <h3 class="text-base sm:text-lg font-semibold text-gray-700">سودآوری پیامک (تومان)</h3>
                        </div>
                    </div>
                    <div class="mt-4 space-y-2">
                ...
                <div class="bg-white overflow-hidden shadow-md sm:rounded-lg p-4 sm:p-6 col-span-1 sm:col-span-2 lg:col-span-4">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 space-y-2 sm:space-y-0">
                        <div class="flex items-center">
                            <div class="flex-shrink-0 bg-purple-500 rounded-md p-3">
                                <i class="ri-coupon-line text-xl sm:text-2xl text-white"></i>
                            </div>
                            <div class="mr-4">
                                <h3 class="text-base sm:text-lg font-semibold text-gray-700">آمار کدهای تخفیف</h3>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                        <div class="bg-blue-50 p-3 sm:p-4 rounded-lg">
                            <div class="text-xl sm:text-2xl font-bold text-blue-600">{{ $totalDiscountCodes }}</div>
                            <div class="text-xs sm:text-sm text-blue-600">کل کدها</div>
                        </div>
                        <div class="bg-green-50 p-3 sm:p-4 rounded-lg">
                            <div class="text-xl sm:text-2xl font-bold text-green-600">{{ $activeDiscountCodes }}</div>
                            <div class="text-xs sm:text-sm text-green-600">فعال</div>
                        </div>
                        <div class="bg-red-50 p-3 sm:p-4 rounded-lg">
                            <div class="text-xl sm:text-2xl font-bold text-red-600">{{ $expiredDiscountCodes }}</div>
                            <div class="text-xs sm:text-sm text-red-600">منقضی شده</div>
                        </div>
                        <div class="bg-yellow-50 p-3 sm:p-4 rounded-lg">
                            <div class="text-xl sm:text-2xl font-bold text-yellow-600">{{ $usedDiscountCodes }}</div>
                            <div class="text-xs sm:text-sm text-yellow-600">استفاده شده</div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <h4 class="font-medium text-gray-800 mb-3 text-sm sm:text-base">آمار استفاده</h4>
                        ...
                        <!-- Top Discount Codes -->
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <h4 class="font-medium text-gray-800 mb-3 text-sm sm:text-base">پرکاربردترین کدها</h4>
                            <div class="space-y-2">
                ...
                <div class="bg-white overflow-hidden shadow-md sm:rounded-lg p-4 sm:p-6 col-span-1 sm:col-span-2 lg:col-span-4">
                    <div class="flex items-center mb-4">
                        <div class="flex-shrink-0 bg-indigo-500 rounded-md p-3">
                            <i class="ri-trophy-line text-xl sm:text-2xl text-white"></i>
                        </div>
                        <div class="mr-4">
                            <h3 class="text-base sm:text-lg font-semibold text-gray-700">۱۰ سالن برتر (بر اساس مصرف پیامک)</h3>
                        </div>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th scope="col" class="px-3 sm:px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">نام سالن</th>
                                    <th scope="col" class="px-3 sm:px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider hidden sm:table-cell">نام سالن‌دار</th>
                                    <th scope="col" class="px-3 sm:px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider hidden md:table-cell">شماره تماس</th>
                                    <th scope="col" class="px-3 sm:px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">مصرف پیامک</th>
                                </tr>
                            </thead>
                                ...
                                @foreach($topSalons as $salon)
                                    <tr>
                                        <td class="px-3 sm:px-6 py-4 text-sm font-medium text-gray-900">
                                            <div class="truncate max-w-32 sm:max-w-none">{{ $salon->name }}</div>
                                            <div class="text-xs text-gray-500 sm:hidden">{{ $salon->user->name ?? '-' }}</div>
                                        </td>
                                        <td class="px-3 sm:px-6 py-4 text-sm text-gray-500 hidden sm:table-cell">{{ $salon->user->name ?? '-' }}</td>
                                        <td class="px-3 sm:px-6 py-4 text-sm text-gray-500 hidden md:table-cell">{{ $salon->user->mobile ?? '-' }}</td>
                                        <td class="px-3 sm:px-6 py-4 text-sm text-gray-500">
                                            <span class="font-semibold bg-gray-200 text-gray-700 px-2 py-1 rounded-full text-xs sm:text-sm">{{ $salon->sms_transactions_count }}</span>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
            ...
            <div class="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="bg-white overflow-hidden shadow-md sm:rounded-lg p-4 sm:p-6 relative" style="min-height: 300px;">
                    <h3 class="text-base sm:text-lg font-semibold mb-4">نرخ رشد کاربران</h3>
                    <div style="height: 250px;">
                        <canvas id="userGrowthChart"></canvas>
                    </div>
                </div>
                <div class="bg-white overflow-hidden shadow-md sm:rounded-lg p-4 sm:p-6 relative" style="min-height: 300px;">
                    <h3 class="text-base sm:text-lg font-semibold mb-4">نمودار فروش</h3>
                    <div style="height: 250px;">
                        <canvas id="salesChart"></canvas>
                    </div>
                </div>
                <div class="bg-white overflow-hidden shadow-md sm:rounded-lg p-4 sm:p-6 relative" style="min-height: 300px;">
                    <h3 class="text-base sm:text-lg font-semibold mb-4">گراف سود پیامک در بازه‌های زمانی</h3>
                    <div style="height: 250px;">
                        <canvas id="smsProfitChart"></canvas>
                    </div>
                </div>
                <div class="bg-white overflow-hidden shadow-md sm:rounded-lg p-4 sm:p-6 relative" style="min-height: 300px;">
                    <h3 class="text-base sm:text-lg font-semibold mb-4">آمار کلی سودآوری پیامک</h3>
                    <div style="height: 250px;">
