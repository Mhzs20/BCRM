...
@section('content')
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            <div>
                <h2 class="text-2xl font-semibold leading-tight">افزودن نحوه آشنایی جدید</h2>
            </div>
            <div class="mt-4">
                <form action="{{ route('admin.how-introduced.store') }}" method="POST">
                    @csrf
                    @include('admin.how-introduced._form')
