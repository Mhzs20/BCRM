            ...
            <div class="flex items-center" x-data="{ open: false }">
                <div class="relative">
                    ...
                    <div x-show="open" @click.away="open = false" 
                         ...
                         class="absolute z-50 mt-2 w-48 rounded-md shadow-lg origin-top-left left-0" style="display: none;">
                        <div class="rounded-md ring-1 ring-black ring-opacity-5 py-1 bg-white">
                            <div class="block px-4 py-2 text-sm text-gray-700 border-b border-gray-100 sm:hidden">
                                {{ Auth::user()->name }}
                            </div>
                            <!-- Authentication -->
