...
@section('header')
    <div class="flex items-center justify-between">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ویرایش کد ت                                                                                     <option value="high" {{ old('monthly_sms_consumption', $discountCode->target_users['monthly_sms_consumption'] ?? '') === 'high' ? 'selected' : '' }}>زیاد (بیشتر از ۵۰۰)</option>
                                            ...
                                            <option value="low" {{ old('monthly_sms_consumption', $discountCode->target_users['monthly_sms_consumption'] ?? '') === 'low' ? 'selected' : '' }}>کم (کمتر از ۱۰۰)</option>                        <option value="last_month" {{ old('last_sms_purchase', $discountCode->target_users['last_sms_purchase'] ?? '') === 'last_month' ? 'selected' : '' }}>یک ماه اخیر</option>
                                            ...
                                            <option value="never" {{ old('last_sms_purchase', $discountCode->target_users['last_sms_purchase'] ?? '') === 'never' ? 'selected' : '' }}>تاکنون خرید نکرده</option>                          <option value="less_than_50" {{ old('sms_balance_status', $discountCode->target_users['sms_balance_status'] ?? '') === 'less_than_50' ? 'selected' : '' }}>کمتر از ۵۰</option>
                                            ...
                                            <option value="zero" {{ old('sms_balance_status', $discountCode->target_users['sms_balance_status'] ?? '') === 'zero' ? 'selected' : '' }}>صفر</option>                              <option value="1" {{ old('status', $discountCode->target_users['status'] ?? '') === '1' ? 'selected' : '' }}>فعال</option>
                                            <option value="0" {{ old('status', $discountCode->target_users['status'] ?? '') === '0' ? 'selected' : '' }}>غیرفعال</option>یف: {{ $discountCode->code }}
        </h2>
        ...
        <div class="p-6">
            ...
            <form action="{{ route('admin.discount-codes.update', $discountCode) }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="date" 
                                   ...
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 @error('starts_at') border-red-500 @enderror">
                            @error('starts_at')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" 
                                   ...
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 @error('expires_at') border-red-500 @enderror">
                            @error('expires_at')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <!-- Usage Limit -->
                    <div>
                        <label for="usage_limit" class="block text-sm font-medium text-gray-700 mb-1">محدودیت تعداد استفاده</label>
                        <input type="number" 
                               name="usage_limit" 
                               id="usage_limit"
                        ...
                        @error('usage_limit')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-sm text-gray-500">اگر خالی بگذارید، محدودیتی برای استفاده وجود نخواهد داشت</p>
                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <select name="sms_balance_status" id="sms_balance_status" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                                                <option value="">همه</option>
                                                <option value="less_than_50" {{ old('sms_balance_status') === 'less_than_50' ? 'selected' : '' }}>کمتر از ۵۰</option>
                                                <option value="less_than_200" {{ old('sms_balance_status') === 'less_than_200' ? 'selected' : '' }}>کمتر از ۲۰۰</option>
                                                <option value="zero" {{ old('sms_balance_status') === 'zero' ? 'selected' : '' }}>صفر</option>
                                            </select>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <select name="last_sms_purchase" id="last_sms_purchase" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                                                <option value="">همه</option>
                                                <option value="last_month" {{ old('last_sms_purchase') === 'last_month' ? 'selected' : '' }}>یک ماه اخیر</option>
                                                <option value="last_3_months" {{ old('last_sms_purchase') === 'last_3_months' ? 'selected' : '' }}>سه ماه اخیر</option>
                                                <option value="last_6_months" {{ old('last_sms_purchase') === 'last_6_months' ? 'selected' : '' }}>شش ماه اخیر</option>
                                                <option value="more_than_6_months" {{ old('last_sms_purchase') === 'more_than_6_months' ? 'selected' : '' }}>بیشتر از شش ماه</option>
                                                <option value="never" {{ old('last_sms_purchase') === 'never' ? 'selected' : '' }}>تاکنون خرید نکرده</option>
                                            </select>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <select name="monthly_sms_consumption" id="monthly_sms_consumption" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                                                <option value="">همه</option>
                                                <option value="high" {{ old('monthly_sms_consumption') === 'high' ? 'selected' : '' }}>زیاد (بیشتر از ۵۰۰)</option>
                                                <option value="medium" {{ old('monthly_sms_consumption') === 'medium' ? 'selected' : '' }}>متوسط (۱۰۰ تا ۵۰۰)</option>
                                                <option value="low" {{ old('monthly_sms_consumption') === 'low' ? 'selected' : '' }}>کم (کمتر از ۱۰۰)</option>
                                            </select>
                                        </div>
                                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // For edit page, don't generate random code or default expiry
