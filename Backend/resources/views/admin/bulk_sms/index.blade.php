...
<div class="container mx-auto px-4 py-6">
    ...
    <h1 class="text-3xl font-extrabold text-gray-900 text-center font-sans">ارسال پیامک گروهی</h1>
    ...
    <div class="bg-white shadow-xl rounded-lg p-6 mb-8">
        <form action="{{ route('admin.bulk-sms.index') }}" method="GET" class="space-y-4 ">
