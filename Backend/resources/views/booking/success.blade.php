...
<body class="bg-gray-100 font-peyda antialiased">
    ...
    <div class="min-h-screen flex flex-col items-center justify-center p-4">
        ...
        <div class="w-full max-w-md bg-white rounded-[2.5rem] shadow-xl overflow-hidden relative">
            ...
            <div class="relative bg-gradient-to-b from-green-50 to-white pt-10 pb-6 px-6 text-center rounded-b-[3rem]">
                ...
                <div class="relative w-full flex items-center justify-center mb-6">
                    <img src="/assets/img/calnder-img.png" alt="Calendar Illustration" class="w-48 h-auto object-contain drop-shadow-xl">
                </div>

                <!-- Success Message Title -->
                <h2 class="text-2xl font-black text-neutral-800 mb-4">
                    نوبت شما با موفقیت <span class="text-green-500">رزرو</span> شد!
                </h2>
