...
class UpdateAppointmentRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'total_duration.integer' => 'مدت زمان کل باید عدد صحیح باشد.',
            'total_duration.min' => 'مدت زمان کل باید حداقل 1 دقیقه باشد.',
            'total_duration.max' => 'مدت زمان کل نمی‌تواند بیشتر از 1440 دقیقه (24 ساعت) باشد.',
