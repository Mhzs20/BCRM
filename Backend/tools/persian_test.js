...
console.log('1404-1-1 =>', persianToGregorian(1404,1,1));
console.log('1404-12-29 =>', persianToGregorian(1404,12,29));
console.log('1404-9-15 =>', persianToGregorian(1404,9,15));
